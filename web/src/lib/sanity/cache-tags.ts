...
export const sanityTags = {
  ...
  programs: "sanity:programs",
  program: "sanity:program",
  programsPage: "sanity:programs-page",
  courseCategory: "sanity:course-category",
  studyLevel: "sanity:study-level",
  faculty: "sanity:faculty",
  degreeType: "sanity:degree-type",
  blog: "sanity:blog",
