...
const documentTypeTags: Record<string, SanityCacheTag[]> = {
  ...
  programsPage: [sanityTags.programsPage, sanityTags.programs],
  ...
  program: [sanityTags.program, sanityTags.programs],
  courseCategory: [sanityTags.courseCategory, sanityTags.programs, sanityTags.homepage],
  studyLevel: [sanityTags.studyLevel, sanityTags.programs, sanityTags.homepage],
  faculty: [sanityTags.faculty, sanityTags.programs],
  degreeType: [sanityTags.degreeType, sanityTags.programs],
