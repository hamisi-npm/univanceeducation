...
import { resolveNewsletterUnsubscribePage } from "@/features/newsletter/services/newsletter-service";
...
export async function generateMetadata({
  ...
  const content = await resolveNewsletterUnsubscribePage({
    token: readToken(params.token),
  });
  return createCmsPageMetadata("/newsletter/unsubscribe", content.seo);
}
