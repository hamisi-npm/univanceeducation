...
import type { UniversitiesHeroContent } from "@/features/universities/types";
import { buttonStyles, sectionStyles } from "@/lib/section-styles";
import { cn } from "@/lib/utils";

type UniversitiesHeroProps = {
  content: UniversitiesHeroContent;
  className?: string;
};

export function UniversitiesHero({ content, className }: UniversitiesHeroProps) {

  return (
    <section
      aria-labelledby="universities-hero-heading"
      className={cn(
