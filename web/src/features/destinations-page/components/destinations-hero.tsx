...
import type { DestinationsHeroContent } from "@/features/destinations-page/types";
import { buttonStyles, sectionStyles } from "@/lib/section-styles";
import { cn } from "@/lib/utils";

type DestinationsHeroProps = {
  content: DestinationsHeroContent;
  className?: string;
};

export function DestinationsHero({ content, className }: DestinationsHeroProps) {
