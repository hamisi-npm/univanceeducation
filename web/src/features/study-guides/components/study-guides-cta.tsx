...
import type { StudyGuidesCtaContent } from "@/features/study-guides/types";
import { sectionStyles } from "@/lib/section-styles";
import { cn } from "@/lib/utils";

type StudyGuidesCtaProps = {
  content: StudyGuidesCtaContent;
  className?: string;
};

export function StudyGuidesCta({ content, className }: StudyGuidesCtaProps) {

  return (
    <section
      aria-labelledby="study-guides-cta-heading"
      className={cn(
