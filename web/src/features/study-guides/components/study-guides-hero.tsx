...
import type { StudyGuidesHeroContent } from "@/features/study-guides/types";
import { buttonStyles, sectionStyles } from "@/lib/section-styles";
import { cn } from "@/lib/utils";

type StudyGuidesHeroProps = {
  content: StudyGuidesHeroContent;
  className?: string;
};

export function StudyGuidesHero({ content, className }: StudyGuidesHeroProps) {

  return (
    <section
      aria-labelledby="study-guides-hero-heading"
      className={cn(
